...
export const initialRegionals: Regional[] = [
  { id: 'reg-sp-capital', name: 'Capital SP', stateId: 'sp', code: 'SP-CAP', defaultPixKeyId: 'key-1' },
  { id: 'reg-porto', name: 'Regional Porto Nacional', stateId: 'to', code: 'RN-PN', defaultPixKeyId: 'key-2' },
];
...
export const initialPixKeys: PixKey[] = [
  ...
  { 
    id: 'key-2', type: 'CNPJ', cnpj: '00000000000100', ownerName: 'CCB REGIONAL PORTO', 
...
export const initialPurposes: PixPurpose[] = [
  { 
    id: 'purp-jb-geral', pixIdentifierId: 'id-jb', name: 'Coleta Geral', shortCode: 'G', 
    displayLabel: 'COLETA GERAL JB0059', messageTemplate: 'COLETA GERAL JB0059', txidSuffix: 'G01', active: true 
  },
  { 
    id: 'purp-jb-const', pixIdentifierId: 'id-jb', name: 'Construção', shortCode: 'C', 
    displayLabel: 'CONSTRUCAO JB0059', messageTemplate: 'CONSTRUCAO JB0059', txidSuffix: 'C01', active: true 
  },
   { 
    id: 'purp-bras-geral', pixIdentifierId: 'id-bras', name: 'Coleta Geral', shortCode: 'G', 
